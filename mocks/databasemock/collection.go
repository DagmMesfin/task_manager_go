...
func (_m *Collection) Aggregate(_a0 context.Context, _a1 interface{}) (domain.Cursor, error) {
...
func (_m *Collection) Find(_a0 context.Context, _a1 interface{}, _a2 ...*options.FindOptions) (domain.Cursor, error) {
	_va := make([]interface{}, len(_a2))
	for _i := range _a2 {
		_va[_i] = _a2[_i]
	}
...
func (_m *Collection) FindOne(_a0 context.Context, _a1 interface{}) domain.SingleResult {
	ret := _m.Called(_a0, _a1)
	...
	if rf, ok := ret.Get(0).(func(context.Context, interface{}) domain.SingleResult); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
