...
func NewClient(connection string) (domain.Client, error) {
...
func (mc *mongoClient) Database(dbName string) domain.Database {
...
func (md *mongoDatabase) Collection(colName string) domain.Collection {
	collection := md.db.Collection(colName)
	return &mongoCollection{coll: collection}
}

func (md *mongoDatabase) Client() domain.Client {
	client := md.db.Client()
	return &mongoClient{cl: client}
}

func (mc *mongoCollection) FindOne(ctx context.Context, filter interface{}) domain.SingleResult {
...
func (mc *mongoCollection) Find(ctx context.Context, filter interface{}, opts ...*options.FindOptions) (domain.Cursor, error) {
